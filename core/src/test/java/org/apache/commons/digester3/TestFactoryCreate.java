...
public class TestFactoryCreate {
	...
	public AbstractObjectCreationFactory<Object> mockAbstractObjectCreationFactory1() throws Exception {
		AbstractObjectCreationFactory<Object> mockInstance = spy(AbstractObjectCreationFactory.class);
		doThrow(new RuntimeException()).when(mockInstance).createObject(any(Attributes.class));
		return mockInstance;
	}
	...
	@Test
	public void testPropagateException() throws Exception, Exception {
		...
		digester.addFactoryCreate("root", mockAbstractObjectCreationFactory1(), ignoreCreateExceptions);
		try {
	...
	public void testFactoryCreateRule() throws Exception {
		...
		digester.addFactoryCreate("root", "org.apache.commons.digester3.ObjectCreationFactoryTestImpl", "override",
				ignoreCreateExceptions);
		digester.addSetNext("root", "add");
		xml = new String("<?xml version='1.0' ?><root one='good' two='bad' three='ugly' "
