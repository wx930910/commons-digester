...
public class DigesterTestCase {
	...
	@Test
	public void testBasicSubstitution() throws Exception, Exception {
		...
		doAnswer((stubInvo) -> {
			...
			tsrBody[0] = text;
			return null;
		}).when(tsr).body(any(String.class), any(String.class), any(String.class));
		doAnswer((stubInvo) -> {
			Attributes attributes = stubInvo.getArgument(2);
			tsrAttributes[0] = new AttributesImpl(attributes);
			return null;
		}).when(tsr).begin(any(String.class), any(String.class), any(Attributes.class));
